...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TelefonosPersona>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("telefonos_persona");

            entity.HasIndex(e => e.PersonaFisicaId, "fk_Telefonos_Persona_persona_fisica1_idx");

            entity.HasIndex(e => e.TelefonoIdTelefono, "fk_Telefonos_Persona_telefono1_idx");

            entity.Property(e => e.PersonaFisicaId).HasColumnName("persona_fisica_ID");
            entity.Property(e => e.TelefonoIdTelefono).HasColumnName("telefono_ID_Telefono");

            entity.HasOne(d => d.PersonaFisica).WithMany()
                .HasForeignKey(d => d.PersonaFisicaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_Telefonos_Persona_persona_fisica1");

            entity.HasOne(d => d.TelefonoIdTelefonoNavigation).WithMany()
                .HasForeignKey(d => d.TelefonoIdTelefono)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_Telefonos_Persona_telefono1");
        });
